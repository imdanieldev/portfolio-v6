<template>
	<div class="calc-height flex items-center justify-center flex-col text-center px-3 select-none">
		<div class="grid grid-cols-1 gap-3 sm:grid-cols-3 w-full mb-3">
			<div @click="goto('https://t.me/imdanieln')"
				...
				<h5 class="text-3xl font-semibold">Telegram</h5>
				<p class="text-xl">@imdanieln</p>
			</div>
			<div @click="goto('https://instagram.com/imdanieln2008')"
				class="overflow-hidden relative w-full h-auto px-2 py-16 bg-white/5 rounded-xl border-2 border-solid border-transparent hover:border-green-500 cursor-pointer flex justify-center items-center flex-col">
				<svg xmlns="http://www.w3.org/2000/svg"
					class="w-full h-32 fill-green-500 absolute opacity-30 blur-sm -z-10" viewBox="0 0 16 16">
					<path
			...
			<div @click="goto('mailto:danialnasronline@gmail.com')"
				...
				<h5 class="text-3xl font-semibold">Email</h5>
				<p class="text-xl">danialnasronline@gmail.com</p>
			</div>
